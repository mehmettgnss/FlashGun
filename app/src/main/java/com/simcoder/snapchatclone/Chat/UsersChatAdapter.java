package com.simcoder.snapchatclone.Chat;
...
public class UsersChatAdapter extends RecyclerView.Adapter<UsersChatAdapter.ViewHolderUsers> {
    ...
    @NonNull
    @Override
    public UsersChatAdapter.ViewHolderUsers onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new UsersChatAdapter.ViewHolderUsers(mContext,LayoutInflater.from(parent.getContext()).inflate(R.layout.user_profile, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull UsersChatAdapter.ViewHolderUsers holder, int position) {
