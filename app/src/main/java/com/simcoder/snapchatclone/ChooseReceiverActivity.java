...
public class ChooseReceiverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            bitmap = BitmapFactory.decodeStream(getApplication().openFileInput("imageToSend4"));
            ...
            usersDb.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if(dataSnapshot.child("displayName").getValue() != null){
                        email = dataSnapshot.child("displayName").getValue().toString();
                    }
